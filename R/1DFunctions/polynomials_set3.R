...
fit=openbt(x_train,y_train,f_train,pbd=c(1.0,0),ntree = 10,ntreeh=1,numcut=300,tc=4,model="mixbart",modelname="physics_model",
           ...
           power = 2.0, base = 0.95, minnumbot = 2, overallsd = sqrt(sig2_hat), k = 3, overallnu = nu,
...
plot(x_test, f0_test, pch = 16, cex = 0.8, main = 'Fits', type = 'l',ylim = c(-15,10))
...
# Save results
filedir = '/home/johnyannotty/Documents/Dissertation/results/1d_functions/'
fit_data = list(
...
saveRDS(fit_data, paste0(filedir,"pwtrig3_results4_10_30_23.rds"))
...
points(geor_vghat2$u,2*vghat_mean)

# Theoretical grid search
grid = expand.grid(a1=c(2,5,10),a2=c(5,10,15),beta=c(1,2),k=c(1,1.25,1.5,2,3))
h_grid = seq(0.1,16,by = 0.1)
...
plot(h_grid,vg_mat[40,], type = "l", ylim = c(0,0.3))
...
saveRDS(out, paste0(filedir,"pwtrig3_thr_variogram_wt_10_30_23.rds"))
